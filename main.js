...
load.action("Action", async function() {
    ...
    //Insert Value in VTS
    const myColumn = vtsClient.createColumn("DevWebTransaction");
    //const columnValues = vtsClient.setValues(["DevWebTransaction"], ["HelloVTS"], load.VTSPlacementType.sameRow);
    //const columnValues = vtsClient.setValues(["Test"], ["HelloVTS"], load.VTSPlacementType.sameRow);
    //Retrive Value in VTS
    //const a = vtsClient.getColumn("Test");
    //const myValue = a.pop();
    //print VTS value
    //load.log(`${myValue}`);
    //----------------------------------------------VTS BLOCK--------------------------------------------
    ...
    if (request1.extractors.isSuccess1) {
        ...
        const columnValues = vtsClient.setValues(["DevWebTransaction"], ["T00_" + T00.duration + ""], load.VTSPlacementType.sameRow);
    } else {
    ...
    if (request2.status === 201) {
        ...
        const columnValues = vtsClient.setValues(["DevWebTransaction"], ["T05_" + T05.duration + ""], load.VTSPlacementType.sameRow);
    } else {
    ...
    T10.stop();
    const columnValues = vtsClient.setValues(["DevWebTransaction"], ["T10_" + T10.duration + ""], load.VTSPlacementType.sameRow);
